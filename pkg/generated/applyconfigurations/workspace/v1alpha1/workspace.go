...
func ExtractWorkspaceFrom(workspace *workspacev1alpha1.Workspace, fieldManager string, subresource string) (*WorkspaceApplyConfiguration, error) {
	b := &WorkspaceApplyConfiguration{}
	err := managedfields.ExtractInto(workspace, internal.Parser().Type("com.github.karmada-io.karmada.pkg.apis.workspace.v1alpha1.Workspace"), fieldManager, b, subresource)
	if err != nil {
		return nil, err
	}
...
// Note that an extracted apply configuration will contain fewer fields than what the fieldManager previously
// applied if another fieldManager has updated or force applied any of the previously applied fields.
func ExtractWorkspace(workspace *workspacev1alpha1.Workspace, fieldManager string) (*WorkspaceApplyConfiguration, error) {
...
func ExtractWorkspaceStatus(workspace *workspacev1alpha1.Workspace, fieldManager string) (*WorkspaceApplyConfiguration, error) {
