...
type WorkspaceInformer interface {
	...
	Lister() workspacev1alpha1.WorkspaceLister
}
	...
	return cache.NewSharedIndexInformer(
		cache.ToListWatcherWithWatchListSemantics(&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.WorkspaceV1alpha1().Workspaces().List(context.Background(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.WorkspaceV1alpha1().Workspaces().Watch(context.Background(), options)
			},
			ListWithContextFunc: func(ctx context.Context, options v1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.WorkspaceV1alpha1().Workspaces().List(ctx, options)
			},
			WatchFuncWithContext: func(ctx context.Context, options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.WorkspaceV1alpha1().Workspaces().Watch(ctx, options)
			},
		}, client),
		&apisworkspacev1alpha1.Workspace{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *workspaceInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apisworkspacev1alpha1.Workspace{}, f.defaultInformer)
}

func (f *workspaceInformer) Lister() workspacev1alpha1.WorkspaceLister {
	return workspacev1alpha1.NewWorkspaceLister(f.Informer().GetIndexer())
}
