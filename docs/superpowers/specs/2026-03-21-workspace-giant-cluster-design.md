...
- Phase-1 deployment artifacts for the workspace apiserver are expected at `artifacts/deploy/karmada-workspace-apiserver.yaml` and `artifacts/deploy/karmada-workspace-apiserver-apiservice.yaml`.
